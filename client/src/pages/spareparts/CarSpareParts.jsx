...
import {
    Car, Package, Gauge, ShoppingCart,
    Settings, Shield, Zap, Star, CheckCircle,
    Clock, Truck, Award, Users, Wrench
} from "lucide-react";
...
export default function CarSpareParts() {
    ...
    const categories = [
        {
            ...
            desc: "Pistons, filters, and engine management systems",
        ...
        },
        {
            icon: Zap,
            title: "Electrical",
            desc: "Batteries, alternators, and lighting systems",
            items: ["Car Batteries", "Headlights", "Alternators", "Starter Motors"]
        },
        {
            icon: Wrench,
            title: "Suspension",
            desc: "Shock absorbers, struts, and steering components",
    ...
    const featuredProducts = [
        { name: "Synthetic Engine Oil", brand: "Mobil", price: "₹1,299", rating: 4.8 },
        { name: "Performance Brake Pads", brand: "Bosch", price: "₹3,499", rating: 4.7 },
        { name: "Car Battery", brand: "Exide", price: "₹5,499", rating: 4.9 }
    ];
    ...
    const benefits = [
        ...
        { icon: Truck, title: "Free Shipping", desc: "On orders above ₹3,000 within the city" },
                ...
                <div className="max-w-6xl mx-auto px-6 text-center">
                    ...
                    <div className="mt-20">
                        <div className="flex flex-col items-center mb-12">
                            ...
                            <p className={`text-lg max-w-3xl mx-auto ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                                Browse our extensive collection of car spare parts by category.
                            </p>
                        </div>
                    ...
                    <div className="mt-20">
                        <div className="flex flex-col items-center mb-12">
                            ...
                            <p className={`text-lg max-w-3xl mx-auto ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                                Our top-selling car parts and accessories.
                            </p>
                        </div>
                    ...
                    <div className="mt-20">
                        <div className="flex flex-col items-center mb-12">
                            ...
                            <div className={`w-24 h-1 rounded-full ${isDark ? "bg-indigo-500" : "bg-indigo-400"} mb-4`}></div>
                            <p className={`text-lg max-w-3xl mx-auto ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                                We stock parts from all major car manufacturers.
                            </p>
                        </div>
                    ...
                    <div className="mt-20">
                        <div className="flex flex-col items-center mb-12">
                            ...
                            <div className={`w-24 h-1 rounded-full ${isDark ? "bg-purple-500" : "bg-purple-400"} mb-4`}></div>
                            <p className={`text-lg max-w-3xl mx-auto ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                                Benefits of using our platform for your car spare parts needs.
                            </p>
                        </div>
                    ...
                    <div className={`mt-20 p-8 rounded-3xl ${isDark ? "bg-gradient-to-r from-indigo-900/30 to-purple-900/30" : "bg-gradient-to-r from-indigo-50 to-purple-50"}`}>
                        ...
                        <p className={`text-lg max-w-2xl mx-auto mb-6 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                            Join hundreds of car shops that have transformed their operations with our management platform.
                        </p>
