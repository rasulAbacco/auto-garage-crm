// client/src/pages/details/components/OCRHistory.jsx
    ...
    return (
        <div>
            <div className="flex justify-end">
                ...
                >
                    <FiClock size={18} />
                    {showHistory ? "Hide History" : `Show History (${historyData.length})`}
                </button>
            </div>

            {showHistory && (
                <div
                    className={`mt-6 rounded-3xl border shadow-xl ${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"
                        }`}
                >
                    <div
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white/80">Your saved OCR history</p>
                                </div>
                            </div>
                            <button
                                onClick={onClear}
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                onClick={() => {
                                                    ...
                                                    a.href = url;
                                                    a.download = `rc_${item.regNo || item.id}.json`;
                                                    a.click();
