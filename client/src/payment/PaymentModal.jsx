   ...
   const options = {
    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-fadeIn">
            <div className={`relative rounded-3xl shadow-2xl p-4 sm:p-6 w-full max-w-[70%] ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white'
                }`}>
                {showSuccess ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="text-center space-y-3">
                            ...
                            <h2 className="text-xl sm:text-2xl font-bold">Complete Your Order</h2>
                        ...
                        <div className={`p-4 rounded-xl ${isDark ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
                            ...
                            <div className="flex justify-between items-center mb-2">
                                <span className={isDark ? 'text-gray-300' : 'text-gray-700'}>Billing</span>
                            ...
                            <div className="flex justify-between items-center mt-3 pt-3 border-t border-gray-600/30">
                                ...
                                <span className="text-xl font-bold text-violet-500">₹{finalPrice}</span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 pt-2">
                            <button
                                onClick={onClose}
                                className={`flex-1 px-4 py-2.5 rounded-lg font-medium transition-all ${isDark ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-100 hover:bg-gray-200'
                                    } text-sm`}
                            >
                                Cancel
                            </button>
